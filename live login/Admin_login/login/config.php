...
$from_email = 'Webmaster@ERMsystem.xyz'; //Webmaster email
$from_name = 'ERM system'; //"From name" displayed on email

//Find specific server settings at https://www.arclab.com/en/kb/email/list-of-smtp-and-pop3-servers-mailserver-list.html
$mailServerType = 'smtp';
//IF $mailServerType = 'smtp'
$smtp_server = 'pod103.unisonserver.com';
$smtp_user = 'webmaster@ermsystem.xyz';
$smtp_pw = 'ermsystem@1234';
...
$timeout_minutes = round(($login_timeout / 300), 1);
