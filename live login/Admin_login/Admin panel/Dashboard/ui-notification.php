                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <!--    <p class="text-muted m-b-20 font-13">
                                     ...
                                     <a class="btn btn-secondary waves-effect"   onclick="$.Notification.notify('custom','top left', 'Sample Notification', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas vitae orci ut dolor scelerisque aliquam.') "  id="error" name="error">Left</a>
                                                ...
                                                if (!$conn) {
                                                    ...
                                                    $result = mysqli_query($conn, $sql);
                                                        ...
                                                        if (mysqli_num_rows($result) > 0) {
                                                            ...
                                                            echo "<script> $.Notification.notify('custom','top left', 'Sample Notification', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas vitae orci ut dolor scelerisque aliquam.');</script>";
                                                        }
...
<!-- Mirrored from coderthemes.com/minton/new_light/ui-notification.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Oct 2017 17:44:28 GMT -->
</html>