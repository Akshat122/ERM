                                    ...
                                    <h1 class="text-center">Assign Task</h1>
                                       ...
                                       <select id="EmpName" name="EmpName" class="col-sm-12  form-control" >
                                            ...
                                            require "dbconf_details.php";
                                             ...
                                             <button style="margin-left: 61px;     border-radius: 8px" class="btn btn-danger waves-effect waves-light btn-m m-b-5" onclick="emp.submit()"  type="submit" >Submit</button>
                                   </div>
                                    </div>
                                <br>
                                       <form method="POST" action="AddNoti.php" id="Task_form" name="Task_form"> 
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                            <textarea class="form-control" rows="5" name="Work" id="Work" onclick="checkform()"></textarea>
                                                        </div>
                                                    </div>
                                     <div class="form-group row">
                                         ...
                                         <button style="margin-left : 30px;"  class="btn btn-danger waves-effect waves-light btn-lg m-b-5" type="reset" >reset</button>
                                        <script>
